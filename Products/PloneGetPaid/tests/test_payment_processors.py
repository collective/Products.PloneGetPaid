...
class TestPaymentMethods(PloneGetPaidTestCase):
    ...
    def test_selection_screen_one_processor(self):
        ...
        self.portal.portal_properties.payment_processor_properties.enabled_processors = [ "dummy"]
    ...
    def test_selection_screen_n_processors(self):
        ...
        self.portal.portal_properties.payment_processor_properties.enabled_processors = [ "dummy", "dummy2"]
    ...
    def test_payment(self):
        ...
        self.assertTrue('name="dummy"' in html) # Check that payment processor button is rendered there
